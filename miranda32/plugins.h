...
void Plugin_NotifyPlugins(long,WPARAM,LPARAM);
void Plugin_NotifyPlugin(int id,long msg,WPARAM wParam,LPARAM lParam); //overloading for a single plugin call (ie show ops
